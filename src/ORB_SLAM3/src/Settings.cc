...
namespace ORB_SLAM3 {
    ...
    // bool Settings::loadFromFile(const std::string &strFile) {
    //     try {
    //         std::cout << "\n*** LOADING SETTINGS ***\n";
            
    //         cv::FileStorage fs(strFile.c_str(), cv::FileStorage::READ);
    //         if(!fs.isOpened()) {
    ...
    //         // 相机基本参数
    //         std::cout << "\nReading basic camera parameters..." << std::endl;
    ...
    //         // 左相机参数
    //         std::cout << "\nReading Camera1 parameters..." << std::endl;
    //         fs["Camera1.fx"] >> camera1.fx;
    //         std::cout << "Camera1.fx: " << camera1.fx << std::endl;
    
    //         fs["Camera1.fy"] >> camera1.fy;
    //         std::cout << "Camera1.fy: " << camera1.fy << std::endl;
    
    //         fs["Camera1.cx"] >> camera1.cx;
    //         std::cout << "Camera1.cx: " << camera1.cx << std::endl;
    
    //         fs["Camera1.cy"] >> camera1.cy;
    //         std::cout << "Camera1.cy: " << camera1.cy << std::endl;
    
    //         // 右相机参数
    //         std::cout << "\nReading Camera2 parameters..." << std::endl;
    //         fs["Camera2.fx"] >> camera2.fx;
    //         std::cout << "Camera2.fx: " << camera2.fx << std::endl;
    //         // ... 其他参数类似
    
    //         // IMU参数
    //         std::cout << "\nReading IMU parameters..." << std::endl;
    //         fs["IMU.NoiseGyro"] >> noiseGyro;
    //         std::cout << "IMU.NoiseGyro: " << noiseGyro << std::endl;
    //         // ... 其他IMU参数
    
    //         // ORB参数
    //         std::cout << "\nReading ORB parameters..." << std::endl;
    //         fs["ORBextractor.nFeatures"] >> nFeatures;
    //         std::cout << "ORBextractor.nFeatures: " << nFeatures << std::endl;
    //         // ... 其他ORB参数
    ...
    //         std::cerr << "Error reading parameter: " << e.what() << std::endl;
    //         return false;
    //     }
    // }
};
