    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    if(!node.empty() && node.isString() && node.string() == "1.0"){
        ...
        // std::cout << "Debug: Before settings printing" << std::endl;
        // try {
        //     // std::cout << (*settings_) << std::endl;
        //     std::cout << "Camera Type: " << settings_->cameraType << std::endl;
        // } catch (const std::exception& e) {
        //     std::cerr << "Exception when printing settings: " << e.what() << std::endl;
        // }
        // std::cout << "Debug: After printing settings" << std::endl;
        // cout << (*settings_) << endl;
    }
    else{
        settings_ = nullptr;
